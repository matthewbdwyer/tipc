...
std::unique_ptr<ConstraintHandler> PolyTypeConstraintCollectVisitor::buildConstraintHandler() {
    return std::make_unique<ConstraintCollector>();
}

std::vector<TypeConstraint> &PolyTypeConstraintCollectVisitor::getCollectedConstraints() {
