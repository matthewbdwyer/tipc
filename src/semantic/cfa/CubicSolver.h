...
private:
    ...
    int size;
    std::vector<std::vector<std::pair<ASTNode*, ASTNode*>>> conditionalConstraints;
};
...
private:
    ...
    std::shared_ptr<CubicSolverNode> killCyclesAt(std::shared_ptr<CubicSolverNode> n);
    std::vector<std::shared_ptr<CubicSolverNode>> findPath(std::shared_ptr<CubicSolverNode> source, std::shared_ptr<CubicSolverNode> target);
    std::shared_ptr<CubicSolverNode> mergePath(std::vector<std::shared_ptr<CubicSolverNode>>& path);
    std::shared_ptr<CubicSolverNode> mergeNodes(std::shared_ptr<CubicSolverNode> n1, std::shared_ptr<CubicSolverNode> n2);
